...
impl SendStream {
    ...
    pub fn append_object_size(&self, size: u64, deadline: Option<u64>, time: Option<u64>) -> Result<(), ClosedStream> {
        self.stream.append_object_size(size, deadline, time).map_err(Into::into)
    }
